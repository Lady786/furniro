const getVariant = (variant?: VariantType) => {
  switch (variant) {
    case "primary":
      return "bg-violet-500 hover:bg-[#B88E2F]  text-white shadow shadow-violet-600/25 hover:shadow-violet-600/75";
    case "danger":
      return "rounded-[50%] bg-red-500 hover:bg-red-700 text-white  shadow shadow-red-600/25 hover:shadow-red-600/75";
    case "success":
      return "rounded-[50%] bg-[#B88E2F]hover:bg-green-700 text-white shadow shadow-green-600/25 hover:shadow-green-600/75";
    case "warning":
    ...
    case "outline-success":
      return "bg-white text-green-500 border border-[#B88E2F] hover:text-white hover:bg-[#B88E2F] ";
    ...
    default:
      return "bg-[#B88E2F] hover:bg-[#B88E2F] text-white shadow shadow-violet-600/25 hover:shadow-violet-600/75";
  }
};
